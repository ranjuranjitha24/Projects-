    ...
    return (
      <div className="page-content" style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflowY: 'auto' }}>
        <header className="app-header" style={{ padding: '24px 0' }}>
          <h1 style={{ fontSize: '1.5rem', marginBottom: '8px' }}>Health Hub</h1>
          <p className="text-light text-sm">Select a condition to view specialized insights, diets, and exercises.</p>
        </header>
